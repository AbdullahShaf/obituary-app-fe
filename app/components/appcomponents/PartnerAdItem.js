...
const PartnerAdItem = ({partner}) => {
    return (
        <div className="min-w-80 flex flex-col w-80">
          ...
          <span className="absolute right-0 top-0 city-tag bg-[#3B3B3B] py-[6px] px-[22px] text-lg leading-6 font-normal z-20">
            {partner.city}
          </span>
            ...
            <div className="min-h-[83px] content-section py-4 px-2 bg-gradient-to-r from-[#E3E8EC] to-white shadow-[5px_5px_10px_rgba(194,194,194,0.4)] shadow-[2px_2px_2px_rgba(0,0,0,0.15)] relative w-[340px]">
              <div className="content flex flex-col gap-[2px] ml-3 mt-1">
                <Link target="_blank" href={partner.link}>
                  <h2 className="text-[#0A85C2] text-sm uppercase leading-6 font-light 
              ...
              <Link target="_blank" href={partner.link}>
                <Image src={CircleArrow} alt={partner.name} className="size-9 absolute right-2 top-2" />
              </Link>
            </div>
